...
// THE shader
// The custom shader function will override this
// When making changes copy the JavaScript version into shaderMain.txt so that it reflects the latest changes
export const shaderMain = (x: number, y: number, w: number, h: number): [number, number, number, number] => {
